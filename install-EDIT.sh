...
gpg --keyserver keyserver.ubuntu.com --recv-keys ED444FF07D8D0BF6 || gpg --export ED444FF07D8D0BF6 | sudo tee /etc/apt/trusted.gpg.d/katoolin3.gpg > /dev/null || die "This may be a server issue. Please try again later";
